...
def monitor():
	...
	with open(log, 'w') as log_file:
		log_file.write('')
	rospy.init_node('beginner_tutorials', anonymous=True)
	pub_error = rospy.Publisher(name = 'beginner_tutorials/monitor_error', data_class = MonitorError, latch = True, queue_size = 1000)
	pub_verdict = rospy.Publisher(name = 'beginner_tutorials/monitor_verdict', data_class = String, latch = True, queue_size = 1000)
...
def main(argv):
	...
	log = '/home/zekeriyya/Desktop/valu3s_tool/rosmonitoring/oracle/TLOracle/logs/online_log.txt' 
	actions = {
		'chatter' : ('filter', 0)
	}
	monitor()
